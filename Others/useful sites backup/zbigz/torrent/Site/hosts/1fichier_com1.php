<?php
		...
		$data1 = $this->curl("http://51.254.9.20/vngstable/index.php", "secureid=".md5("12311g5r@gr6g1r1vdfe@fef897efe"), "urllist=".urlencode($url));
		$data2 = $this->curl("http://generatemylinks.com/index.php", "secureid=".md5(), "urllist=".urlencode($url));
