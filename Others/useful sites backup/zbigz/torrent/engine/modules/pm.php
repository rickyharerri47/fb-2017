...
function reload () {
	...
	document.getElementById('dle-captcha').innerHTML = '<img src="engine/modules/antibot/antibot.php?rndval=' + rndval + '" border="0" width="160" height="80" alt="" /><br /><a onclick="reload(); return false;" href="#">{$lang['reload_code']}</a>';
