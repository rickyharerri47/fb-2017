...
msgbox("info","informations", "<form action=\"index.php\" method=\"GET\">Mise à niveau de la base de données de la version <b>9.2</b> à la version <b>9.3</b> Réussi.<br />{$error_info}<br />Cliquez sur Suivant pour continuer la mise à jour du script<br /><br /><input type=\"hidden\" name=\"next\" value=\"93\"><input class=\"edit\" type=\"submit\" value=\"Suivant ...\"></form>");
?>