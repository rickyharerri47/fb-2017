$(document).ready(function() {
	...
	{
		var getLinks = $('<a href="'+LinksItem[i]+' style="background: url(http://warez.meximas.com/templates/File-Template/images/tt-fav.png) -'+sdvig+'px top  no-repeat;" target="_blank"></a>');
